...
- in Widget component we can notice:
  ...
  - there are 2 types of widgets:
    ...
    - one which allows adding a new currency pair to let the user follow SELL and BUY rates. This contains 2 dropdowns where Primary and Secondary currencies can be selected the ones obtained by calling the backend through startPolling() method
